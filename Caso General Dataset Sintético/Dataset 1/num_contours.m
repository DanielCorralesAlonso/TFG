function [nLevels, cmap] = num_contours(vect)
m = min(vect);
M = max(vect);
...
if m < 0.1
    ...
    clr2 = repmat([0.2802 0.2764 0.9204], 4*(3000 - 1000), 1);
...
elseif (0.1 <= m) && (m < 0.3)
    ...
    clr3 = repmat([0.1954 0.7765 0.6225], 14*(7000 - 5000), 1);
    clr4 = repmat([0.86 0.7413 0.1587], 8*(9000 - 7000) , 1);
    clr5 = repmat([0.9769 0.9839 0.0805], (1/2)*(10000 - 9000) , 1);
